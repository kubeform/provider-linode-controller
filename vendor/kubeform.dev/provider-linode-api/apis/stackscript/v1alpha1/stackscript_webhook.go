...
var stackscriptForceNewList = map[string]bool{
	"/is_public": true,
}
...
func (r *Stackscript) ValidateUpdate(old runtime.Object) error {
	...
	for key := range stackscriptForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`stackscript "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
