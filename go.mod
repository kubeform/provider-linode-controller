...
require (
	...
	kubeform.dev/provider-linode-api v0.3.1-0.20210824200123-9889de8576f3
	kubeform.dev/terraform-backend-sdk v0.0.0-20210922115523-21574335f0db
	sigs.k8s.io/cli-utils v0.25.0
	sigs.k8s.io/controller-runtime v0.9.0
)

//replace kubeform.dev/terraform-backend-sdk => github.com/kubeform/terraform-backend-sdk

//replace github.com/hashicorp/terraform-plugin-sdk/v2 => github.com/kubeform/terraform-plugin-sdk/v2 v2.6.1-0.20210917042256-d16bd17f787e
