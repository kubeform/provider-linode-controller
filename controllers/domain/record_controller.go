...
func (r *RecordReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &domainv1alpha1.Record{}); err != nil {
			klog.Error(err, "unable to set up auditor", domainv1alpha1.Record{}.APIVersion, domainv1alpha1.Record{}.Kind)
			return err
		}
	}
...
func (r *RecordReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Record")
			return nil
		}
		...
		resourceList := &domainv1alpha1.RecordList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Record")
			return nil
		}
