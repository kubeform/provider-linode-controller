...
// +kubebuilder:rbac:groups=domain.linode.kubeform.com,resources=domains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=domain.linode.kubeform.com,resources=domains/status,verbs=get;update;patch
...
func (r *DomainReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &domainv1alpha1.DomainList{}
