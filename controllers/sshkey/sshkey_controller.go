...
func (r *SshkeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sshkeyv1alpha1.Sshkey{}); err != nil {
			klog.Error(err, "unable to set up auditor", sshkeyv1alpha1.Sshkey{}.APIVersion, sshkeyv1alpha1.Sshkey{}.Kind)
			return err
		}
	}
...
func (r *SshkeyReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Sshkey")
			return nil
		}
		...
		resourceList := &sshkeyv1alpha1.SshkeyList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Sshkey")
			return nil
		}
