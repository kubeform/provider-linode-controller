...
// +kubebuilder:rbac:groups=instance.linode.kubeform.com,resources=ips,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=instance.linode.kubeform.com,resources=ips/status,verbs=get;update;patch
...
func (r *IpReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Ip")
			return nil
		}
