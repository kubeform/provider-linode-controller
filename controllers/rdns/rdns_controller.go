...
// +kubebuilder:rbac:groups=rdns.linode.kubeform.com,resources=rdns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rdns.linode.kubeform.com,resources=rdns/status,verbs=get;update;patch
...
func (r *RdnsReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Rdns")
			return nil
		}
