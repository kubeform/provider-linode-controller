...
// StorageObjectReconciler reconciles a StorageObject object
...
// +kubebuilder:rbac:groups=object.linode.kubeform.com,resources=storageobjects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=object.linode.kubeform.com,resources=storageobjects/status,verbs=get;update;patch

func (r *StorageObjectReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("storageobject", req.NamespacedName)
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch StorageObject")
...
func (r *StorageObjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &objectv1alpha1.StorageObject{}); err != nil {
			klog.Error(err, "unable to set up auditor", objectv1alpha1.StorageObject{}.APIVersion, objectv1alpha1.StorageObject{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&objectv1alpha1.StorageObject{}).
...
func (r *StorageObjectReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for StorageObject")
			return nil
		}
		...
		resourceList := &objectv1alpha1.StorageObjectList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list StorageObject")
			return nil
		}
