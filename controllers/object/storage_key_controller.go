...
func (r *StorageKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &objectv1alpha1.StorageKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", objectv1alpha1.StorageKey{}.APIVersion, objectv1alpha1.StorageKey{}.Kind)
			return err
		}
	}
...
func (r *StorageKeyReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for StorageKey")
			return nil
		}
		...
		resourceList := &objectv1alpha1.StorageKeyList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list StorageKey")
			return nil
		}
