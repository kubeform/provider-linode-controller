...
// +kubebuilder:rbac:groups=image.linode.kubeform.com,resources=images,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=image.linode.kubeform.com,resources=images/status,verbs=get;update;patch
...
func (r *ImageReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Image")
			return nil
		}
		...
		resourceList := &imagev1alpha1.ImageList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Image")
			return nil
		}
