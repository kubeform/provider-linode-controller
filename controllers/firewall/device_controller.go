...
// +kubebuilder:rbac:groups=firewall.linode.kubeform.com,resources=devices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=firewall.linode.kubeform.com,resources=devices/status,verbs=get;update;patch
...
func (r *DeviceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &firewallv1alpha1.Device{}); err != nil {
			klog.Error(err, "unable to set up auditor", firewallv1alpha1.Device{}.APIVersion, firewallv1alpha1.Device{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&firewallv1alpha1.Device{}).
